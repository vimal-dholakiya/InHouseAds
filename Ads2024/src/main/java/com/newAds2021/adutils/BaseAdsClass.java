...
import com.newAds2021.adsmodels.DataAPI;
import com.newAds2021.adsmodels.DataCallback;
import com.newAds2021.adsmodels.DataModel;
import com.newAds2021.adsmodels.DataResponse;
...
public class BaseAdsClass extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener {
                ...
                try {
                    if (adsDetails.getIhAdsDetail() != null) {
                        ...
                        if (ihAdsDetails != null && ihAdsDetails.size() > 0) {
                            ...
                            adsPrefernce.setAdsDefaults(ihAdsDetails.get(1).getIhads_id(),
                                    ihAdsDetails.get(1).getShowad(),
                                    ihAdsDetails.get(1).getOpenin(),
                                    ihAdsDetails.get(1).getApplink(),
                                    ihAdsDetails.get(1).getShowreview(),
                                    ihAdsDetails.get(1).getReviewcount(),
                                    ihAdsDetails.get(1).getShowrating(),
                                    ihAdsDetails.get(1).getRatingcount(),
                                    ihAdsDetails.get(1).getTitle(),
                                    ihAdsDetails.get(1).getSubtitle(),
                                    ihAdsDetails.get(1).getIcon(),
                                    ihAdsDetails.get(1).getExtratext(),
                                    ihAdsDetails.get(1).getShowdouble(),
                                    ihAdsDetails.get(1).getButtontext(),
                                    ihAdsDetails.get(1).getBigimage(),
                                    ihAdsDetails.get(1).getDesc_title(),
                                    ihAdsDetails.get(1).getDesc_text());
                            for (int i = 2; i < ihAdsDetails.size(); i++) {
    ...
    public void getData(DataCallback callback) {
        ...
        DataAPI.apiInterface().getData(ConstantAds.adUrlId, "Data").enqueue(new Callback<DataResponse>() {
            @Override
            public void onResponse(Call<DataResponse> call, retrofit2.Response<DataResponse> response) {
                try {
                    if (response.body() != null && response.body().getDatalist() != null) {
                        ArrayList<DataModel> dataList = response.body().getDatalist();
                        callback.onSuccess(dataList);  // Pass the result back through the callback
                    } else {
            ...
            public void onFailure(Call<DataResponse> call, Throwable t) {
                callback.onFailure(t);  // Pass the error back through the callback
            }
        });
    }
                ...
                if (savedInterAdDetails.size() != 0) {
                    ...
                    tv_install_btn_inter.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            } else if (interAd.getOpenin().equals("amazon")) {
                                try {
                                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("amzn://apps/android?p=" +  interAd.getApplink()));
                                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(intent);
                                } catch (android.content.ActivityNotFoundException anfe) {
                                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.amazon.com/gp/mas/dl/android?p=" +  interAd.getApplink()));
                                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(intent);
                                }
                            }else {
                ...
                if (savedIhAdsDetails.size() != 0) {
                    ...
                    tv_install_btn_banner.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            } else if (bannerAd.getOpenin().equals("amazon")) {
                                try {
                                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("amzn://apps/android?p=" +  bannerAd.getApplink()));
                                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(intent);
                                } catch (android.content.ActivityNotFoundException anfe) {
                                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.amazon.com/gp/mas/dl/android?p=" +  bannerAd.getApplink()));
                                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(intent);
                                }
                            } else {
...
//            cardView.setBackground(getResources().getDrawable(R.drawable.gnt_rounded_corners_shape));
            ...
            if (nativeDetails.size() != 0) {
                ...
                btn_ad_install_native.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        }else if (nativeAd.getOpenin().equals("amazon")) {
                            try {
                                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("amzn://apps/android?p=" +  nativeAd.getApplink()));
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                            } catch (android.content.ActivityNotFoundException anfe) {
                                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.amazon.com/gp/mas/dl/android?p=" +  nativeAd.getApplink()));
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                            }
                        }  else {
    ...
    public void showBannerAd() {
        if (isConnected(this) && adsPrefernce.extrapara2() && adsPrefernce.extrapara7()) {
    ...
    public void showNativeAd(boolean isSmall, View nativeView) {
        if (isConnected(this) && adsPrefernce.extrapara2() && adsPrefernce.extrapara13()) {
            if (isSmall) {
    ...
    public void showInterstitialAd(Activity context, Callable<Void> callable) {
        if (isConnected(this) && adsPrefernce.extrapara2() && adsPrefernce.extrapara5()){
